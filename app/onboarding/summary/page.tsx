...
export default function SummaryPage() {
  ...
  useEffect(() => {
    const profile = {
      ...
      activityLevel: (sessionStorage.getItem("onboarding_activityLevel") ?? "moderate") as Profile["activityLevel"],
      goalType: (sessionStorage.getItem("onboarding_goal") ?? "fat_loss") as Profile["goalType"],
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      pregnancyStatus: (sessionStorage.getItem("onboarding_pregnancyStatus") ?? "none") as Profile["pregnancyStatus"],
      chronicConditions: JSON.parse(sessionStorage.getItem("onboarding_chronicConditions") ?? "[]") as Profile["chronicConditions"],
        medications: JSON.parse(sessionStorage.getItem("onboarding_medications") ?? "[]") as Profile["medications"],
      };
