    ...
    <div className="min-h-screen p-6" style={{ background: "var(--background)" }}>
      <div className="max-w-md mx-auto">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div><label className="input-label">Training Days Per Week</label><input id="trainingDays" type="number" value={trainingDays} onChange={(e)=>setTrainingDays(Number(e.target.value))} min={0} max={7} className="input" /></div>
        ...
        <button onClick={()=>{sessionStorage.setItem("onboarding_activityLevel",activityLevel);sessionStorage.setItem("onboarding_trainingDays",String(trainingDays));sessionStorage.setItem("onboarding_dietPreference",dietPreference);router.push("/onboarding/summary")}}
