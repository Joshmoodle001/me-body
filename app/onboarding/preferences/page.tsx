    ...
    <div className="min-h-screen p-6" style={{ background: "var(--background)" }}>
      <div className="max-w-md mx-auto">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div><label className="input-label">Training Days Per Week</label><input id="trainingDays" type="text" inputMode="numeric" value={trainingDays} onChange={(e)=>setTrainingDays(e.target.value.replace(/\D/g,""))} min={0} max={7} className="input" /></div>
