  ...
  return (
    <div className="app-container">
      ...
      <form onSubmit={(e) => { e.preventDefault(); if (barcode.trim()) doLookup(barcode); }} className="mb-6">
        <label htmlFor="scanBarcode" className="input-label">Enter barcode number</label>
        <div className="flex gap-2">
          <input id="scanBarcode" type="text" inputMode="numeric" value={barcode} onChange={(e) => setBarcode(e.target.value.replace(/\D/g, ""))} placeholder="e.g. 6001234567890" className="input flex-1" autoFocus />
